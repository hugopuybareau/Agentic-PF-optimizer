                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="card-platine p-8 rounded-lg">
                            <h2 className="text-nav font-semibold mb-6">
                                Send us a message
                            </h2>
                            ...
                            <form className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sub text-sm mb-2">
                                            First name
                                        </label>
                                        <input
                                            type="text"
                        ...
                        <div className="space-y-8">
                            <div className="card-platine p-8 rounded-lg">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            <h3 className="text-nav font-medium">
                                                Email
                                            </h3>
                                            <p className="text-sub">
                                                hello@platine-agents.com
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="card-platine p-8 rounded-lg">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <h3 className="text-nav font-medium mb-2">
                                            How secure is my data?
                                        </h3>
                                        <p className="text-sub text-sm">
                                            We use bank-level encryption and
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sub text-sm">
                                            Yes, get started with a 14-day free
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sub text-sm">
                                            Absolutely. Cancel your subscription
