...
const features = [
    {
        ...
        description:
            'Real-time insights into your investment performance with AI-powered analytics',
        icon: (
            <svg
                className="w-8 h-8"
                fill="none"
    ...
    },
    {
        ...
        description:
            'Conversational AI that understands your financial goals and provides personalized guidance',
        icon: (
            <svg
                className="w-8 h-8"
                fill="none"
    ...
    },
    {
        title: 'Smart Alerts',
        description:
            'Proactive notifications about market changes, risks, and opportunities',
        icon: (
            <svg
                className="w-8 h-8"
                fill="none"
    ...
    },
    {
        ...
        description:
            'Stay ahead with AI-curated market insights and trend analysis',
        icon: (
            <svg
                className="w-8 h-8"
                fill="none"
    ...
    },
    {
        ...
        description:
            'AI-driven recommendations to improve diversification and performance',
        icon: (
            <svg
                className="w-8 h-8"
                fill="none"
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-sub max-w-2xl mx-auto">
                            platine agents combines advanced AI with financial
                            expertise to help you make smarter investment
                            decisions
                        </p>
                    </div>
                    ...
                    <div className="mt-20 text-center">
                        <div className="card-platine p-12 rounded-lg">
                            ...
                            <p className="text-sub mb-8 max-w-md mx-auto">
                                Join thousands of investors using AI to optimize
                                their portfolios
                            </p>
